...
public class Grid
{
   ...
   private void preloadImages(){
      ...
      images.add(getImageFromFile("destructibleblock.jpg"));
      images.add(getImageFromFile("reinforcedblock.jpg")); // 5
      images.add(getImageFromFile("bomb.gif"));
      images.add(null);//getImageFromFile("fire.jpg")); // 7
      images.add(getImageFromFile("radiusbooster.png"));
      images.add(getImageFromFile("maxlivebombsbooster.png")); // 9
      images.add(getImageFromFile("lifesbooster.gif"));
      images.add(getImageFromFile("p1u.gif"));//11
      images.add(getImageFromFile("p1us.png"));
      images.add(getImageFromFile("p1d.gif"));//13
      images.add(getImageFromFile("p1ds.png"));
      images.add(getImageFromFile("p1l.gif"));//15
      images.add(getImageFromFile("p1ls.png"));
      images.add(getImageFromFile("p1r.gif"));//17
      images.add(getImageFromFile("p1rs.png"));
      images.add(null);//19 bomb2.gif
      images.add(getImageFromFile("centerx.gif"));
      images.add(getImageFromFile("horizx.gif")); // 21
      images.add(getImageFromFile("vertx.gif"));
      images.add(null); // 23
      images.add(null);
      images.add(getImageFromFile("p2u.gif"));//25
      images.add(getImageFromFile("p2us.png"));
      images.add(getImageFromFile("p2d.gif"));//27
      images.add(getImageFromFile("p2ds.png"));
      images.add(getImageFromFile("p2l.gif"));//29
      images.add(getImageFromFile("p2ls.png"));
      images.add(getImageFromFile("p2r.gif"));//31
      images.add(getImageFromFile("p2rs.png"));
      images.add(getImageFromFile("unstoppablebomb.png")); // 33
      images.add(getImageFromFile("ubomb.gif"));
      images.add(null); // 35 ubomb2.gif
      images.add(getImageFromFile("mine.png"));
      images.add(getImageFromFile("mine.gif")); // 37
      images.add(getImageFromFile("remotemine_red.gif"));
      images.add(getImageFromFile("deathbooster.gif")); // 39
      images.add(getImageFromFile("nuke.gif"));
      images.add(getImageFromFile("nukebooster.png")); // 41
      ...
      images.add(getImageFromFile("semidestructibleblock.jpg")); // 45
      images.add(getImageFromFile("semidestructibleblock_damaged1.jpg")); 
      images.add(getImageFromFile("semidestructibleblock_damaged2.jpg")); // 47
      images.add(getImageFromFile("proximitymine.gif"));
      ...
      images.add(getImageFromFile("gateblockp1.gif")); // 53
      images.add(getImageFromFile("gateblockp2.gif"));
      images.add(getImageFromFile("remoteminetrigger_covered.gif")); // 55
      images.add(getImageFromFile("remoteminetrigger_uncovered.gif"));
      images.add(getImageFromFile("warp.jpg")); // 57
      images.add(getImageFromFile("remotemine_blue.gif"));
      images.add(getImageFromFile("indestructibleblock.jpg")); // 59
   }
   public void reloadBombAnimations(){
       images.remove(6);
       images.add(6,getImageFromFile("bomb.gif",true));
       images.remove(34);
       images.add(34,getImageFromFile("ubomb.gif",true));
       images.remove(37);
       images.add(37,getImageFromFile("mine.gif",true));
   }
