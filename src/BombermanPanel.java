...
public class BombermanPanel extends JPanel {
   ...
   public static final String levelPath = "src/resources" + File.separator + "levels" + File.separator; 
    ...
    */
   public BombermanPanel(JFrame newWindow,JPanel newContent,JPanel newBottomPanel,JPanel newStatsPanel, ArrayList<JLabel> newStatsLabels,JLabel newInfoLabel,String levelPath) {
   ...
   private JMenuBar getMenuBar() {
      ...
      int levelCount = 0;
      File file = new File(BombermanPanel.levelPath + "level"+(levelCount+1)+".txt");
      while(grid.getScannerFromFile(file) != null){
          levelCount++;
          file = new File(BombermanPanel.levelPath + "level"+(levelCount+1)+".txt");
      }
   ...
   private class MenuHandler implements ActionListener {
      public void actionPerformed(ActionEvent evt) { 
         ...
         if (command.equals("New Local Game"))
            ...
            levelFile = new File(BombermanPanel.levelPath + "level"+command.substring(6)+".txt");
            doNewGame(levelFile);
